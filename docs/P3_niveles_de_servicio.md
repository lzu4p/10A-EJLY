...
| 4 | **Tasa de errores del CRUD** | % de peticiones 5xx en los endpoints de productos y usuarios | **< 1.0 %** | **< 5.0 %** | Complementa la disponibilidad midiendo la corrección funcional, no solo que el servidor esté encendido. Un 1 % en el volumen esperado (decenas de operaciones diarias) equivale a menos de una falla al día. |
